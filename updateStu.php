...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['User_ID'])) {
    ...
    $result = $conn->query("SELECT * FROM student WHERE `User_ID` = $student_id");
...
<form method="post" action="updateStu.php">
    ...
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $fstnameErr == "" && $lstnameErr == "" && $genderErr == "" && $DoBErr == "" && $bgErr == "" && $religionErr == "" && $nidErr == "" && $fnameErr == "" && $mnameErr == "" && $ssc_gpaErr == "" && $hsc_gpaErr == "" && $emailErr == "" && $pwdErr == "" && $facultyErr == "") {

        // Insert data into the database
        $sql = "INSERT INTO student ( First_Name,Last_Name, Gender, DateOfBirth, Blood_Group, Religion, NID, Father_Name, Mother_Name, SSC_gpa, HSC_gpa, Email, Password_, Faculty) VALUES ('$fstname', '$lstname', '$gender', '$DoB', '$bg', '$religion', '$nid', '$fname', '$mname', '$ssc_gpa', '$hsc_gpa', '$bsc_cgpa', '$msc_cgpa', '$email', '$pwd', '$faculty')";
