...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['User_ID'])) {
    $stuff_id = $_GET['User_ID'];

    $result = $conn->query("SELECT * FROM stuff WHERE `User_ID` = $stuff_id");
...
<form method="post" action="updateStuff.php">
    <input type="hidden" name="stuff_id" value="<?php echo $row['User_ID']; ?>">
    
    <input type="hidden" name="User_ID" value="<?php echo $row['User_ID']; ?>">

    <input type="hidden" name="user" value="<?php echo $stuff_id ?>">
    ...
    <input type="submit" name="update" value="Update Stuff">
</form>
</fieldset>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $fstnameErr == "" && $lstnameErr == "" && $genderErr == "" && $DoBErr == "" && $bgErr == "" && $religionErr == "" && $nidErr == "" && $fnameErr == "" && $mnameErr == "" && $emailErr == "" && $pwdErr == "") {
        ...
        $sql = "INSERT INTO stuff ( First_Name,Last_Name, Gender, DateOfBirth, Blood_Group, Religion, NID, Father_Name, Mother_Name, Email, Password_, Faculty) VALUES ('$fstname', '$lstname', '$gender', '$DoB', '$bg', '$religion', '$nid', '$fname', '$mname', '$email', '$pwd')";
