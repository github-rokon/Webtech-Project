...
<img src="Student.png" alt="Student" width="120" height="120">
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return registration()" novalidate>
  ...
  <input type="submit" name="submit" value="Insert Student" class="button">
</form>
</table>
</fieldset>
...
<?php
if ($_SERVER["REQUEST_METHOD"] == "POST" && $fstnameErr == "" && $lstnameErr == "" && $genderErr == "" && $DoBErr == "" && $bgErr == "" && $religionErr == "" && $nidErr == "" && $fnameErr == "" && $mnameErr == "" && $ssc_gpaErr == "" && $hsc_gpaErr == ""  && $emailErr == "" && $pwdErr == "" && $DeptErr == "") {

    // Insert data into the database
    $sql = "INSERT INTO student ( First_Name,Last_Name, Gender, DateOfBirth, Blood_Group, Religion, NID, Father_Name, Mother_Name, SSC_gpa, HSC_gpa, Email, Password_, Dept) VALUES ('$fstname', '$lstname', '$gender', '$DoB', '$bg', '$religion', '$nid', '$fname', '$mname', '$ssc_gpa', '$hsc_gpa', '$email', '$pwd', '$Dept')";
